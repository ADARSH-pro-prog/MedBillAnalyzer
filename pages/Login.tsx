...
import { Activity, Lock, User, Loader2, AlertCircle, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto animate-slide-up relative z-10">
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-slate-600 dark:text-slate-400 text-lg">Access your medical analysis dashboard</p>
      </div>
      ...
      <div className="w-full glass-card rounded-3xl p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="mt-8 pt-6 border-t border-slate-200/60 dark:border-slate-700/60 text-center">
          <p className="text-sm text-slate-600 dark:text-slate-400">
            ...
            <Link to={ROUTES.REGISTER} className="font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400 transition-colors hover:underline">
              Register now
            </Link>
          </p>
        </div>
